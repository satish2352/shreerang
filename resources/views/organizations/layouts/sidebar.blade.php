            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <li class="">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Inbox" href="{{route('organizations-list-employees')}}"><i class="fa fa-inbox sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Add Employees</span></a></li>
                            </ul>
                        </li>
                @endif
                ...
                @if(session()->get('role_name')=='Purchase')   
                        ...
                        <li>
                            <a class="has-arrow" href="{{route('list-purchase-order')}}" aria-expanded="false"><i class="fa big-icon fa-envelope icon-wrap"></i> <span class="mini-click-non">Purchase Orders</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Inbox" href="{{route('list-purchase-order')}}"><i class="fa fa-inbox sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">List Purchase Orders</span></a></li>
                            </ul>
                        </li>
                @endif
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="{{route('organization-log-out')}}"><span class="fa fa-lock author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
