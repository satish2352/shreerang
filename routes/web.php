...
Route::group(['middleware' => 'organizations:Hr. Departments'], function () {
...
Route::group(['middleware' => ['organizations:Designer']], function () {
...
Route::group(['middleware' => ['organizations:Production']], function () {
